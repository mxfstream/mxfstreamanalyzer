...
namespace Cinegy.MXFstreamAnalyzer
{
    ...
    internal class Program
    {
        ...
        private static int Run(Options opts)
        {
            ...
            _logger.Info($"Cinegy MXFstream Monitoring and Analysis Tool (Built: {File.GetCreationTime(location)})");
        ...
        private static void PrintConsoleFeedback()
        {
            ...
            lock (pidMetrics)
            {
                ...
                PrintToConsole(_analyzer.LastPcr > 0 ? $"\nPCR Value: {span}\n----------------" : "\n\n");
